...
import com.mengcc.ms.adminuser.model.enums.RequestMethodEnum;
...
public class SysAction implements Serializable {
    ...
    @ApiModelProperty(value = "操作请求方式", required = true)
    private RequestMethodEnum actionMethod;
    ...
    @Size(max = 128, message = "备注最大长度128", groups = {Default.class, UpdateGroup.class})
